...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(* com.windmill.zyfz.syncTimer.service.zyfz..*.*(..))")
    private void db1Aspect() {
    }

    @Pointcut("execution(* com.windmill.zyfz.syncTimer.service.wlxy..*.*(..))")
    private void db2Aspect() {
    }

    @Pointcut("execution(* com.windmill.zyfz.syncTimer.service.js_zyfz..*.*(..))")
